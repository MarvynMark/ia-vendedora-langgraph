...
<fluxo>
  ...
  **Mensagem 2 (VALOR primeiro, depois o número quebrado no custo por dia — nunca o número "pelado"):**
  - Anual Completo: "É o investimento pra um cargo de Perito que começa entre R$ 15 e 20 mil por mês, o retorno de passar cobre isso rápido. O Anual só com a minha mentoria fica em 12x de R$ 315; o Anual Completo fica em 12x de R$ 394 (uns R$ 13 por dia) ou R$ 3.997 à vista no PIX — ou seja, só uns R$ 79 a mais por mês. E por esses R$ 79 já vem a assinatura Premium do Estratégia Concursos inclusa (videoaulas de todas as matérias, PDFs, banco de questões, simulados), que sozinha no site já sai por quase R$ 2.000. Sai muito mais em conta levar junto do que comprar por fora."
  > **Essa comparação Anual Completo × Anual normal na MESMA mensagem é PROPOSITAL (ancoragem), não bombardeio** — os dois têm quase o mesmo preço e a única diferença é o material, então mostrar lado a lado faz o Completo parecer o negócio óbvio (empurra pra CIMA). É o oposto de mostrar Anual × Semestral (que empurra pra baixo — esse continua sendo um por vez). Recomende o Completo com clareza; o Anual normal aparece só como referência de preço.
